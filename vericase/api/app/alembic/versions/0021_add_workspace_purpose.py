"""Add workspace_purpose baseline table.

Revision ID: 0021
Revises: 0020
Create Date: 2026-01-24

This migration creates the workspace_purpose table used by the Purpose tab.
"""
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS workspace_purpose CASCADE;")
