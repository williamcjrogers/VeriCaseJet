...
export const EmailGrid: React.FC<EmailGridProps> = ({
  rowData,
  onRowClicked,
}) => {
    ...
    () => [
      ...
      },
      {
        ...
        valueGetter: (params: ValueGetterParams<Email>) => {
          ...
          const content =
            params.data?.meta?.content || params.data?.content || "";
          return content.includes("<html") || content.includes("To:")
            ? extractField(content, "To")
            : "-";
        },
      ...
      },
      {
        ...
        valueGetter: (params: ValueGetterParams<Email>) => {
          ...
          const content =
            params.data?.meta?.content || params.data?.content || "";
          return content.includes("<html") || content.includes("CC:")
            ? extractField(content, "CC")
            : "-";
        },
        filter: "agTextColumnFilter",
      },
      ...
      },
      {
        ...
        valueGetter: (params: ValueGetterParams<Email>) => {
          ...
          return realAttachments
            .map(
              (att: { filename?: string; name?: string }) =>
  ...
  return (
    <div style={containerStyle} className="ag-theme-quartz vericase-grid">
      <AgGridReact<Email>
        rowData={rowData}
