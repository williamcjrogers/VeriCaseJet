class MigrationEngine:
    ...
    def migrate_to_exchange(self, data):
        ...
        if isinstance(data, str) and "invalid" in data:
            return {
                "success": False,
                "message": "Migration failed due to invalid PST file.",
            }

        # Simulate success
        return {
            "success": True,
            "message": "Migration to Exchange completed successfully.",
        }
    ...
    def migrate_to_sqlite(self, data):
        ...
        return {
            "success": True,
            "message": "Migration to SQLite completed successfully.",
        }
