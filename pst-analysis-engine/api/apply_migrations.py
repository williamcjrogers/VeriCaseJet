...
if match:
    ...
    print("URL: {DATABASE_URL[:50]}..." if len(DATABASE_URL) > 50 else DATABASE_URL)
...
try:
    ...
    for migration_file in migration_files:
        ...
        try:
            ...
            cursor.execute(sql)
            print("   [OK] Successfully applied {migration_file.name}")
        except Exception as e:
            print("   [WARNING] Error applying {migration_file.name}: {e}")
