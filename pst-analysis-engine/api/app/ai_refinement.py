...
KNOWN_UK_PROJECT_NAMES = [
    ...
    "Walton on the Naze",
    "Patmore Estate",
    "William Paton Gardens",
    "Vandome Close",
    "Grange Walk",
    "Park Place Manchester",
...
"""
    ...
    async def generate_intelligent_questions(
        ...
        if detected_duplicates:
            total_dup_count = sum(
                item.email_count - 1 for item in detected_duplicates
            )  # Count duplicates, not originals
            questions.append(
                RefinementQuestion(
                    ...
                    options=[
                        {
                            "value": "remove_all",
                            "label": f"Remove all {total_dup_count} duplicate emails (keep originals)",
                        },
                        {
                            "value": "select_individual",
                            "label": "Let me review and select which duplicates to remove",
                        },
                        {
                            "value": "keep_all",
                            "label": "Keep all emails including duplicates",
                        },
                    ],
            ...
            questions.append(
                RefinementQuestion(
                    ...
                    options=[
                        {
                            "value": "exclude_all",
                            "label": "Exclude all emails mentioning other projects",
                        },
                        {
                            "value": "select_individual",
                            "label": "Let me review and select which to exclude",
                        },
                        {
                            "value": "keep_all",
                            "label": "Keep all emails (these might be related)",
                        },
                    ],
            ...
            questions.append(
                RefinementQuestion(
                    ...
                    options=[
                        {
                            "value": "exclude_all",
                            "label": f"Exclude all {total_spam_count} spam/newsletter emails",
                        },
                        {
                            "value": "select_individual",
                        ...
                        {
                            "value": "keep_all",
                            "label": "Keep all (I need to review these manually)",
                        },
                    ],
                    ...
                    options=[
                        {
                            ...
                            "label": "Add selected domains to project stakeholders",
                        },
                        {
                            "value": "exclude_selected",
                            "label": "Exclude emails from unselected domains",
                        },
                        {
                            "value": "review_later",
                            "label": "Skip for now, I'll review later",
                        },
                    ],
            ...
            if council_domain_candidates:
                questions.append(
                    RefinementQuestion(
                        ...
                        options=[
                            {
                                "value": "select_council",
                                "label": "Select from detected authorities below",
                            },
                            {
                                "value": "not_applicable",
                                "label": "No council involvement in this project",
                            },
                            {
                                "value": "enter_manually",
                                "label": "Enter council name manually",
                            },
                        ],
                ...
                options=[
                    {
                        ...
                        "label": "Select from high-volume senders below",
                    },
                    {
                        "value": "enter_details",
                        "label": "Enter client details manually",
                    },
                ],
                detected_items=[
                    p for p in detected_people[:10]
                ],  # Top 10 senders as candidates
                priority=5,
                stage=RefinementStage.PEOPLE_VALIDATION,
            )
        )
        ...
        contractor_candidates = [
            ...
            for p in detected_people
            if any(
                term in (p.name or "").lower()
                or term in (p.metadata.get("domain", "") or "").lower()
                for term in [
                    "construction",
                    "build",
                    "civil",
                    ...
                    options=[
                        {
                            ...
                            "label": "Include only selected contractors",
                        },
                        {
                            "value": "include_all",
                            "label": "Include all contractors shown",
                        },
                        {
                            "value": "exclude_none_relevant",
                            "label": "None of these are relevant to this project",
                        },
                    ],
                    detected_items=(
                        contractor_candidates
                        if contractor_candidates
                        else detected_people[:15]
                    ),
                    priority=6,
                    stage=RefinementStage.PEOPLE_VALIDATION,
                )
